  ...
  final List<Map<String, dynamic>> _riwayatChat = [
    {
      'isMe': true,
      'text':
          'Halo min, kuota tiket admin toko saya habis (0). Boleh minta QRIS untuk beli 10 tiket?',
      'time': '10:00',
      'isImage': false,
    },
    {
      'isMe': false,
      'text':
          'Halo kak! Siap, ini QRIS manual Nusopa.Mart sebesar Rp 10.000 untuk 10 tiket ya. Silakan di-scan dan bayar via e-wallet/m-banking.',
      'time': '10:02',
      'isImage': false,
    },
    {
    ...
    },
    {
      'isMe': true,
      'text':
          'Sudah saya bayar ya min, ini bukti transfernya. Tolong di-input manual tiketnya.',
      'time': '10:05',
      'isImage': false,
    },
    {
      'isMe': false,
      'text':
          'Baik kak, pembayaran terverifikasi! 10 Tiket sudah di-input ke dasbor toko Anda. Silakan dicek kembali. Terima kasih!',
      'time': '10:07',
      'isImage': false,
    },
  ];
