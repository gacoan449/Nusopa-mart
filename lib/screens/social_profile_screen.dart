...
class _SocialProfileScreenState extends State<SocialProfileScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (_, snapshot) {
            ...
            final title =
                (data?['displayName'] ?? widget.userName ?? 'Profil').toString();
            return Text(
              title,
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final name =
              (profile['displayName'] ?? widget.userName ?? 'Pengguna').toString();
  ...
  Widget _actionButtons(String name) {
    if (own) {
      return Row(
        children: [
          Expanded(
  ...
  Widget _count(String collection, String label) {
    return Expanded(
  ...
  Widget _postCard(QueryDocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    return SocialCard(
      child: Column(
        ...
        children: [
          SocialPostHeader(
            avatar: (data['authorPhotoUrl'] ?? '').toString(),
            name: (data['authorName'] ?? 'Pengguna').toString(),
            time: time,
          ),
          ...
          SocialInteractionBar(
            ...
            onLike: () => SocialService.instance.toggleLike(
              doc.id,
              authorId: (data['authorId'] ?? '').toString(),
            ),
            onComment: () {},
            onShare: () => SocialService.instance.sharePost(
              doc.id,
              authorId: (data['authorId'] ?? '').toString(),
            ),
          ),
        ...
        child: Padding(
          ...
          child: Center(
            child: Text(
              ...
              style: GoogleFonts.inter(color: SocialTheme.muted),
            ),
          ),
        ),
      ),
  ...
  Widget _posts() {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: FirebaseFirestore.instance
          .collection('posts')
          .where('authorId', isEqualTo: profileUid)
          .snapshots(),
      builder: (_, snapshot) {
        final docs = [
          ...(snapshot.data?.docs ??
  ...
  Widget _products() {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: FirebaseFirestore.instance
          .collection('products')
          .where('sellerId', isEqualTo: profileUid)
          .snapshots(),
      builder: (_, snapshot) {
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                ...
                                label: const Text('Belanja / Rekber'),
                              ),
                            ),
                          ],
                        ),
    ...
    final items = own
        ? <Widget>[
            ...
            ListTile(
              ...
              title: const Text('Kelola Produk & Toko'),
              onTap: () => Navigator.push(
                context,
            ...
            ListTile(
              ...
              title: const Text('Rekber & Perlindungan Transaksi'),
              onTap: () => Navigator.push(
                context,
        ...
        : <Widget>[
            ListTile(
              ...
              title: const Text('Laporkan profil'),
